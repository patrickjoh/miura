...
class LSTM(nn.Module):
    def __init__(self, x_values, y_values, input_size=1, hidden_size=10, num_layers=1, output_size=1, num_epochs=50, learning_rate=0.005):
    ...
    def train_model(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            output = self(self.x_scaled)  # Forward pass
            optimizer.zero_grad()  # Clear the gradients
            loss = loss_fn(output, self.y_scaled.view(-1, 1))  # Compute the loss
