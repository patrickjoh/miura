...
class LSTM_inc(nn.Module):
    def __init__(self, input_size=1, hidden_size=10, num_layers=1, output_size=1, batch_size=3, num_epochs=50, learning_rate=0.005):
    ...
    def create_dataloader(self, x_scaled, y_scaled):
    ...
    def initialize(self, x_values, y_values):
        ...
        # Create DataLoader
        train_loader = self.create_dataloader(x_scaled, y_scaled)
        # Train the model
